...
<a href="loginp2.jsp">
        ...
        <table id="search_container" class="active">
              <tbody ><tr>
                ...
                <td class="search_field_clear">
                  <form action="sqlSearch.jsp" method="POST">
  ...
  <td class="search_form_input_clear">
      ...
      Class.forName("com.mysql.jdbc.Driver");
       con2 = DriverManager.getConnection("jdbc:mysql://localhost/all_db?user=root&password=");
   } catch(Exception e) {
      e.printStackTrace();
   }
...
Statement stmt = con2.createStatement();
            ResultSet rs = stmt.executeQuery("SELECT * FROM hissite_join WHERE column1 LIKE '%searchTerm%' OR column2 LIKE '%searchTerm%' OR column3 LIKE '%searchTerm%';");
BasicDBObject whereQuery = new BasicDBObject();
...
//                out.print("Number of rows"+number);
                ...
                DBCursor cursor = collection.find(whereQuery).limit(200);
...
<%}%> 
     ...
     height="90" ></td>
          ...
          <% if( strNew2 != null) { %>
            ...
            <%}else if(strNew2 == ""){%> <td><%out.print("null");%> </td><%}%>
