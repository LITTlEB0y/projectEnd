...
<%}%> 
     ...
     height="260" ><br><%out.print(obj.get("PIC_DESC")); %></td>
     ...
     height="90" ><br><%out.print(obj.get("PIC_DESC")); %></td>
          ...
          <% if( obj.get("REG_HISTORY") != null) { %>
            <td><%out.print(obj.get("REG_HISTORY")+"<br><br>รายละเอียดสถานที่ : "+obj.get("REG_PRESENT")+"<br><br>ถนน : "+obj.get("POS_ROAD"));%></td>
            <%}else if(obj.get("REG_HISTORY") == null){%> <td><%out.print("วัฒนธรรม: "+obj.get("REG_ART_CULTURE"));%> </td> <%}%>
